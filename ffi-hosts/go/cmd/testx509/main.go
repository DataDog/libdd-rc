...
const (
	...
	remoteQueriesServiceCancelRunURI = "rc.x509.magic_tunnel.remote_queries.v1alpha1.RemoteQueriesService/CancelRun"
)
...
func main() {
	...
	if err := client.RegisterHandler(remoteQueriesServiceCancelRunURI, handleCancelRun); err != nil {
		log.Fatal(err)
	}
