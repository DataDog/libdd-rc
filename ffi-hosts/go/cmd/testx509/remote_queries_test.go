...
func TestHandleStartRun(t *testing.T) {
	...
	callHandler(t, handleStartRun, &remotequeriesv1alpha1.StartRunRequest{Integration: "postgres"}, &resp)
...
func TestHandleResolveTarget(t *testing.T) {
	...
	callHandler(t, handleResolveTarget, &remotequeriesv1alpha1.ResolveTargetRequest{Integration: "postgres"}, &resp)
